import svgPaths from "./svg-cswckap8g2";
...
import imgScreenshot1 from "./ece298d0ec2c16f10310d45724b276a6035cb503.png";
...
function TextContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[#00594f] text-[16px] tracking-[1px] w-[min-content]">Enter company information</p>
    </div>
  );
}
...
function TextContainer2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[#00594f] text-[16px] tracking-[1px] w-[min-content]">Select exemption reason</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Text">
      <p className="font-['Poppins:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#6b6b6b] text-[0px] tracking-[1px] w-full">
        <span className="leading-[24px] text-[16px]">{`Choose the reason that applies to your business from the list of qualifying exemptions. If you don't see your exemption reason listed, you can request an exemption by emailing `}</span>
        <span className="[text-decoration-skip-ink:none] decoration-solid font-['Poppins:SemiBold',sans-serif] leading-[24px] text-[#00594f] text-[16px] underline">calsavers@treasurer.ca.gov.</span>
      </p>
    </div>
  );
}
...
function Screenshot1() {
  return (
    <div className="bg-[#fdfdfb] content-stretch flex flex-[1_0_0] flex-col items-center justify-center min-h-px overflow-clip relative w-full" data-name="Screenshot">
      <div className="-translate-x-1/2 absolute h-[242.257px] left-1/2 top-[12.63px] w-[376.781px]" data-name="image 275">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function TextContainer3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[#00594f] text-[16px] tracking-[1px] w-[min-content]">Review exemption request details</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Text">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#6b6b6b] text-[16px] tracking-[1px] w-full">{`Review your information to make sure everything is correct, then click Submit to continue to instructions to submit any supporting documentation based on your exemption selection. `}</p>
    </div>
  );
}
...
function Screenshot2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center justify-center min-h-px overflow-clip relative w-full" data-name="Screenshot">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot1} />
    </div>
  );
}
...
function TextContainer4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[#00594f] text-[16px] tracking-[1px] w-[min-content]">Submit supporting documentation</p>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Text">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#6b6b6b] text-[16px] tracking-[1px] w-full">{`If required, follow the online instructions to provide proof of existing retirement plan or other supporting documents. You'll receive a confirmation email with your exemption status.`}</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="bg-[#e5eeed] h-[43.984px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[11.992px] px-[11.992px] relative size-full">
        <p className="font-['Poppins:Italic',sans-serif] italic leading-[21px] relative shrink-0 text-[14px] text-black text-center tracking-[1px] w-full">Supporting documents preview</p>
      </div>
    </div>
  );
}
...
function Group1() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Group">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Accordion">
        <AccordionExpanded3 />
        <div className="bg-white relative shrink-0 w-full" data-name="Step=Step 8">
          <div className="overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex flex-col gap-[32px] items-start p-[32px] relative size-full">
              <Steps3 />
            </div>
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Accordion">
        <AccordionExpanded4 />
        <div className="bg-white relative shrink-0 w-full" data-name="Step=Step 7">
          <div className="overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex flex-col gap-[32px] items-start p-[32px] relative size-full">
              <Steps4 />
            </div>
...
export default function EligibilityTabsToggle() {
  return (
    <div className="content-stretch flex flex-col isolate items-start relative size-full" data-name="Eligibility Tabs Toggle">
      <Frame />
    </div>
  );
}