import svgPaths from "./svg-5d8tvpqvbu";
import imgScreenshot from "./200c7787c7cfa10c4e336e217f05d9d65c719b58.png";
import imgImage from "./1be263d120b563f150451ac6cfb6291ac8e8042f.png";
import imgImage275 from "./5f7c71a946ceaa3165e4600dc6064f01095c05d8.png";
import imgImage274 from "./eff1046475126ca5c8666f8302a9b8adef90ad12.png";
import imgImage276 from "./8daddc77dbbd4947e255e71e2c2b551451076ff4.png";
...
function Group9() {
  return (
    <button className="cursor-pointer grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="bg-[#e6e6e6] border border-[#d3d3d3] border-solid col-1 h-[24px] ml-0 mt-0 rounded-[24px] row-1 w-[44px]" data-name="Background" />
      <Switch />
    </button>
  );
}
...
function TextContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[#00594f] text-[16px] tracking-[1px] w-[min-content]">Enter your EIN/TIN and Access Code on the registration and exemption page</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-w-px relative" data-name="Text">
      <p className="font-['Poppins:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#6b6b6b] text-[0px] tracking-[1px] w-[min-content]">
        ...
        <span className="[text-decoration-skip-ink:none] decoration-solid font-['Poppins:SemiBold',sans-serif] leading-[24px] text-[#00594f] text-[16px] underline">Request an Access Code</span>
  ...
  return (
    <div className="bg-[#e5eeed] h-[43.984px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[11.992px] px-[11.992px] relative size-full">
        <p className="font-['Poppins:Italic',sans-serif] italic leading-[21px] relative shrink-0 text-[14px] text-black text-center tracking-[1px] w-full">Registration page preview</p>
      </div>
    </div>
  );
}
        ...
        <div className="content-stretch flex flex-col items-start p-[1.25px] relative size-full">
          <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Screenshot">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[159.81%] left-0 max-w-none top-[-8.9%] w-full" src={imgScreenshot} />
            </div>
          </div>
          <Container />
        </div>
...
function TextContainer2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[#00594f] text-[16px] tracking-[1px] w-[min-content]">Complete exemption check</p>
    </div>
  );
}
      ...
      <div className="font-['Poppins:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#6b6b6b] text-[0px] tracking-[1px] w-full whitespace-pre-wrap">
        <p className="mb-0 text-[16px]">
          ...
          <a className="[text-decoration-skip-ink:none] cursor-pointer decoration-solid font-['Poppins:SemiBold',sans-serif] leading-[24px] not-italic text-[#00594f] tracking-[1px] underline" href="mailto:calsavers@treasurer.ca.gov" target="_blank">
            <span className="[text-decoration-skip-ink:none] decoration-solid underline" href="mailto:calsavers@treasurer.ca.gov" target="_blank">
...
function Screenshot1() {
  return (
    <div className="bg-[#fdfdfb] content-stretch flex flex-[1_0_0] flex-col items-center min-h-px overflow-clip relative w-full" data-name="Screenshot">
      <div className="-translate-x-1/2 absolute h-[242.257px] left-1/2 top-[18px] w-[376.781px]" data-name="image 275">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[157.52%] left-[-60.57%] max-w-none top-[-8.72%] w-[161.37%]" src={imgImage275} />
        </div>
      </div>
    </div>
  );
...
function Container2() {
  return (
    <div className="bg-[#e5eeed] h-[43.984px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[11.992px] px-[11.992px] relative size-full">
        <p className="font-['Poppins:Italic',sans-serif] italic leading-[21px] relative shrink-0 text-[14px] text-black text-center tracking-[1px] w-full">Exemption check preview</p>
      </div>
    </div>
  );
}
...
function TextContainer3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[#00594f] text-[16px] tracking-[1px] w-[min-content]">Add account administrators and choose username/password</p>
    </div>
  );
}
...
function Screenshot2() {
  return (
    <div className="bg-[#fdfdfb] content-stretch flex flex-[1_0_0] flex-col items-center justify-center min-h-px overflow-clip relative w-full" data-name="Screenshot">
      <div className="-translate-x-1/2 absolute h-[242.257px] left-1/2 top-[16.63px] w-[376.781px]" data-name="image 274">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[152.55%] left-[-55.39%] max-w-none top-[-8.43%] w-[156.27%]" src={imgImage274} />
        </div>
      </div>
    </div>
  );
...
function Container3() {
  return (
    <div className="bg-[#e5eeed] h-[43.984px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[11.992px] px-[11.992px] relative size-full">
        <p className="font-['Poppins:Italic',sans-serif] italic leading-[21px] relative shrink-0 text-[14px] text-black text-center tracking-[1px] w-full">Add administrator preview</p>
      </div>
    </div>
  );
}
...
function NumberContainer4() {
  return (
    <div className="bg-[#80641f] content-stretch flex flex-col items-center justify-center p-[8px] relative rounded-[32px] shrink-0 size-[32px]" data-name="Number Container">
      <p className="font-['Poppins:Medium',sans-serif] leading-[21px] not-italic relative shrink-0 text-[14px] text-center text-white tracking-[1px] w-full">5</p>
    </div>
  );
}
...
function TextContainer4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[#00594f] text-[16px] tracking-[1px] w-[min-content]">Review your registration details and submit</p>
    </div>
  );
}
...
function Screenshot3() {
  return (
    <div className="bg-[#fdfdfb] content-stretch flex flex-[1_0_0] flex-col items-center justify-center min-h-px overflow-clip relative w-full" data-name="Screenshot">
      <div className="-translate-x-1/2 absolute h-[242.257px] left-1/2 top-[7.63px] w-[376.781px]" data-name="image 274">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[160.52%] left-[-64.18%] max-w-none top-[-8.51%] w-[164.44%]" src={imgImage276} />
        </div>
      </div>
    </div>
  );
...
function Container4() {
  return (
    <div className="bg-[#e5eeed] h-[43.984px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[11.992px] px-[11.992px] relative size-full">
        <p className="font-['Poppins:Italic',sans-serif] italic leading-[21px] relative shrink-0 text-[14px] text-black text-center tracking-[1px] w-full">Review and submit preview</p>
      </div>
    </div>
  );
}
...
function Group1() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Group">
      ...
      <button className="content-stretch cursor-pointer flex flex-col items-start relative shrink-0 w-full" data-name="Accordion Hover">
        <AccordionExpanded1 />
...
function RegisterNovice() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Register/Novice">
      <Group1 />
    </div>
  );
}
...
function TabText3() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-center relative shrink-0" data-name="Tab Text">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#00594f] text-[16px] text-left tracking-[1px] whitespace-nowrap">Request an Exemption</p>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start leading-[0] min-w-px not-italic relative text-black tracking-[1px]" data-name="Text">
      <div className="flex flex-col font-['Poppins:SemiBold',sans-serif] justify-center relative shrink-0 text-[16px] w-full">
        <p className="leading-[24px]">Automate this step with payroll integration</p>
      </div>
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center relative shrink-0 text-[0px] w-full">
        <p className="text-[16px]">
          <span className="leading-[24px]">{`Payroll integration automates key payroll tasks—saving time every pay cycle and reducing the need for ongoing staff involvement. `}</span>
          <span className="[text-decoration-skip-ink:none] decoration-solid font-['Poppins:SemiBold',sans-serif] leading-[24px] not-italic text-[#00594f] tracking-[1px] underline">Learn More</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Poppins:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#6b6b6b] text-[0px] tracking-[1px] w-full">
        <span className="leading-[24px] text-[16px]">{`After registering, you will be required to complete your account setup and `}</span>
        <span className="[text-decoration-skip-ink:none] decoration-solid font-['Poppins:SemiBold',sans-serif] leading-[24px] text-[#00594f] text-[16px] underline">upload your employee roster</span>
        <span className="leading-[24px] text-[16px]">{` within 30 days. CalSavers will then notify your employees about the program, initiating a 30-day opt-out window.`}</span>
      </p>
      <div className="bg-[#e5eeed] relative rounded-[8px] shrink-0 w-full" data-name="PayrollBanner">
          ...
          <div className="content-stretch flex gap-[48px] items-center px-[32px] py-[24px] relative size-full">
            ...
            <div className="bg-white content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[8px] relative rounded-[4px] shrink-0" data-name="Button">
              ...
              <div className="flex flex-col font-['Poppins:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#00594f] text-[16px] text-center tracking-[1px] whitespace-nowrap">
                <p className="leading-[24px]">Watch Video</p>
              </div>
              <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon">
                <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="Primary">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                    <path d={svgPaths.p337fa380} fill="var(--fill-0, #00594F)" id="Primary" />
                  </svg>
                </div>
              </div>
            </div>
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black tracking-[1px] whitespace-nowrap">What to do after registration:</p>
      <Container11 />
    </div>
  );
}

function RegisterNovice1() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full z-[2]" data-name="Register/Novice">
      <Accordions />
      <div className="h-0 relative shrink-0 w-full" data-name="HR">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1044 1">
            <line id="HR" stroke="var(--stroke-0, #C3C3C3)" x2="1044" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Container10 />
...
function Group3() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] isolate items-start relative shrink-0 w-full z-[2]" data-name="Group">
      <StepText1 />
      <RegisterNovice1 />
    </div>
  );
...
function TextContainer15() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[24px] min-w-px not-italic relative text-[16px] tracking-[1px]" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] relative shrink-0 text-black w-full">Enter company information and complete exemption check</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[#6b6b6b] w-full">Fill out company details in the form and choose your business type in the exemption check</p>
    </div>
  );
}
...
function TextContainer16() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[24px] min-w-px not-italic relative text-[16px] tracking-[1px]" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] relative shrink-0 text-black w-full">Add account administrators and choose username/password</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[#6b6b6b] w-full">Provide contact information for Account Manager and Administrators assisting the account and enter account credentials for login.</p>
    </div>
  );
}
...
function TextContainer17() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[24px] min-w-px not-italic relative text-[16px] tracking-[1px]" data-name="Text Container">
      <p className="font-['Poppins:SemiBold',sans-serif] relative shrink-0 text-black w-full">Review and Submit</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[#6b6b6b] w-full">Double-check details and submit for Plan approval</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Poppins:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#6b6b6b] text-[0px] tracking-[1px] w-full">
        <span className="leading-[24px] text-[16px]">C</span>
        <span className="leading-[24px] text-[16px]">{`omplete your account setup and `}</span>
        <span className="[text-decoration-skip-ink:none] decoration-solid font-['Poppins:SemiBold',sans-serif] leading-[24px] text-[#00594f] text-[16px] underline">upload your employee roster</span>
        <span className="leading-[24px] text-[16px]">{` within 30 days. CalSavers will then notify your employees about the program, initiating a 30-day opt-out window.`}</span>
      </p>
      <div className="bg-[#e5eeed] relative rounded-[8px] shrink-0 w-full" data-name="PayrollBanner">
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black tracking-[1px] whitespace-nowrap">Reminder of what to do after registration:</p>
      <Container15 />
    </div>
  );
}
...
function RegisterExerienced() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full z-[1]" data-name="Register/Exerienced">
      <StepsContainer />
      <div className="h-0 relative shrink-0 w-full" data-name="HR">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1044 1">
...
function TabText8() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-center relative shrink-0" data-name="Tab Text">
      <p className="[text-decoration-skip-ink:none] decoration-solid font-['Poppins:SemiBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#00473f] text-[16px] text-left tracking-[1px] underline whitespace-nowrap">Request an Exemption</p>
    </div>
  );
}
...
export default function Frame6() {
  return (
    <div className="content-start flex flex-wrap gap-[0px_188px] items-start relative size-full">
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-[1140px]" data-name="Exempt Tab Toggle Off">
        <Frame1 />
      </div>
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0" data-name="Registration Tab Toggle Off">
        <Frame />
      </div>
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-[1140px]" data-name="Exempt Tab Toggle On">
        <Frame4 />
      </div>
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0" data-name="Registration Tab Toggle On">
        <Frame7 />
      </div>
      <button className="bg-[#e5eeed] content-stretch cursor-pointer flex flex-col h-[72px] items-start justify-center relative rounded-tl-[8px] rounded-tr-[8px] shrink-0" data-name="TabSetup Hover State">
        <div aria-hidden="true" className="absolute border border-[#00594f] border-solid inset-0 pointer-events-none rounded-tl-[8px] rounded-tr-[8px]" />
        <TextIcon8 />
        <Spacer8 />
      </button>
    </div>
