...
import imgImage277 from "./35f67c4f48e0916172710ca12bd4ebdfa1402a04.png";
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px not-italic relative text-left" data-name="Text">
      <p className="font-['Poppins',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#343a40] text-[14px] tracking-[1.5px] uppercase whitespace-nowrap">360° Integration</p>
...
function Text1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px not-italic relative text-left" data-name="Text">
      <p className="font-['Poppins',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#80641f] text-[14px] tracking-[1.5px] uppercase whitespace-nowrap">180° Integration</p>
      <div className="flex flex-col font-['Poppins',sans-serif] font-medium justify-center leading-[0] min-w-full relative shrink-0 text-[20px] text-black tracking-[1px] w-[min-content]">
...
function TabText() {
  return (
    <div className="content-stretch flex flex-col font-['Poppins',sans-serif] font-semibold h-full items-start justify-center not-italic relative shrink-0 whitespace-nowrap" data-name="Tab Text">
      <p className="leading-[21px] relative shrink-0 text-[#80641f] text-[14px] tracking-[1.5px] uppercase">180° Integration</p>
      <p className="leading-[24px] relative shrink-0 text-[16px] text-black tracking-[1px]">Overview</p>
    </div>
  );
}
...
function TabText1() {
  return (
    <div className="content-stretch flex flex-col font-['Poppins',sans-serif] font-semibold h-full items-start justify-center not-italic relative shrink-0 text-left whitespace-nowrap" data-name="Tab Text">
      ...
      <p className="leading-[24px] relative shrink-0 text-[#00594f] text-[16px] tracking-[1px]">Payroll Integrations Inc.</p>
    </div>
  );
}
...
function InnerContainer1() {
  return (
    <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[repeat(1,fit-content(100%))] relative shrink-0 w-full" data-name="InnerContainer">
      <div className="aspect-[696/341] col-3 justify-self-stretch relative row-1 shrink-0" data-name="image 277">
...
function Steps() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center max-w-[1140px] relative shrink-0 w-full" data-name="Steps">
      <Header />
      <Levelradios />
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-[1140px]" data-name="180 - Tab 1">
        <Tabs />
        <Body />
      </div>
    </div>
...
function IfTab1Selected() {
  return (
    <div className="absolute bg-[#f2f0e9] content-stretch flex flex-col items-center justify-center left-[409px] overflow-clip py-[80px] top-[405px] w-[1440px]" data-name="If Tab 1 Selected">
      <Steps />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="bg-[#e5eeed] h-[43.984px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[11.992px] px-[11.992px] relative size-full">
        <p className="font-['Poppins',sans-serif] italic italic leading-[21px] relative shrink-0 text-[14px] text-black text-center tracking-[1px] w-full">Initiate 180 payroll integration preview</p>
      </div>
    </div>
  );
}
...
function Steps1() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center max-w-[1140px] relative shrink-0 w-full" data-name="Steps">
      <Header1 />
      <Levelradios1 />
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-name="180 - Tab 2 - Toggle Off">
        <Tabs1 />
        <Body1 />
      </div>
    </div>
...
function IfTab2SelectedAndToggleIsOff() {
  return (
    <div className="absolute bg-[#f2f0e9] content-stretch flex flex-col items-center justify-center left-[1961px] overflow-clip py-[80px] top-[405px] w-[1440px]" data-name="If Tab 2 Selected and Toggle is Off">
      <Steps1 />
    </div>
  );
}
...
function Steps7() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center max-w-[1140px] relative shrink-0 w-full" data-name="Steps">
      <Header2 />
      <Levelradios2 />
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-name="180 - Tab 2 - Toggle On">
        <Tabs2 />
        <Body2 />
      </div>
    </div>
...
function IfTab2SelectedAndToggleIsOn() {
  return (
    <div className="absolute bg-[#f2f0e9] content-stretch flex flex-col items-center justify-center left-[3513px] overflow-clip py-[80px] top-[405px] w-[1440px]" data-name="If Tab 2 Selected and Toggle is On">
      <Steps7 />
    </div>
  );
}
...
export { Group2 as Tab180SetupToggleOffContent };
export { Group4 as Tab180SetupToggleOnContent };

export default function Component180TabExamples() {
  return (
    <div className="bg-white relative size-full" data-name="180 Tab Examples">
      <IfTab1Selected />
      <IfTab2SelectedAndToggleIsOff />
      <IfTab2SelectedAndToggleIsOn />
    </div>
  );
}