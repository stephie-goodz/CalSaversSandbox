import svgPaths from "./svg-v8qnq13vts";
...
function Row() {
  return (
    <div className="content-stretch flex gap-[24px] h-[252px] items-start relative shrink-0 w-full" data-name="Row">
      <Step1 />
      <Step />
    </div>
  );
...
function TextContainer4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[24px] min-w-px not-italic relative text-[16px] tracking-[1px]" data-name="Text Container">
      <p className="font-['Poppins',sans-serif] font-semibold relative shrink-0 text-black w-full">{`Payroll provider authorization & setup`}</p>
      <p className="font-['Poppins',sans-serif] relative shrink-0 text-[#6b6b6b] w-full">Finish your connection by logging into your payroll provider account and follow on-screen instructions.</p>
    </div>
  );
}
...
function Steps() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center max-w-[1140px] relative shrink-0 w-full" data-name="Steps">
      <Header />
      <Levelradios />
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-[1140px]" data-name="Tab 2 - Payroll Integrations Inc. - Toggle  ON">
        <Tabs />
        <Body />
      </div>
    </div>
...
function Tab2PayrollIntegrationsIncToggleOnExample() {
  return (
    <div className="bg-[#f2f0e9] content-stretch flex flex-col items-center justify-center mb-[-1px] overflow-clip py-[80px] relative shrink-0 w-[1440px]" data-name="Tab 2 - Payroll Integrations Inc. - Toggle  ON Example">
      <Steps />
    </div>
  );
}
...
export default function Component2Tab2PayrollIntegrationsIncWithToggleOn() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="2. Tab 2 (Payroll Integrations Inc.) with toggle ON">
      <Navigation />
      <Hr />
      <Hero />
      <Tab2PayrollIntegrationsIncToggleOnExample />
      <Section />
      <Chatbot />
      <Section1 />
