...
function TabText2() {
  return (
    <div className="content-stretch flex flex-col font-['Poppins',sans-serif] font-semibold h-full items-start justify-center not-italic relative shrink-0 whitespace-nowrap" data-name="Tab Text">
      <p className="leading-[21px] relative shrink-0 text-[#80641f] text-[14px] tracking-[1.5px] uppercase">Setup Guide</p>
      <p className="leading-[24px] relative shrink-0 text-[16px] text-black tracking-[1px]">Paychex or TJH Payroll</p>
    </div>
  );
}
...
function Steps() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center max-w-[1140px] relative shrink-0 w-full" data-name="Steps">
      <Header />
      <Levelradios />
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-[1140px]" data-name="Tab 3 - Paychex or TJH Payroll - Toggle Off">
        <Tabs />
        <Body />
      </div>
    </div>
...
function Tab3PaychexOrTjhPayrollToggleOffExample() {
  return (
    <div className="bg-[#f2f0e9] content-stretch flex flex-col items-center justify-center mb-[-1px] overflow-clip py-[80px] relative shrink-0 w-[1440px]" data-name="Tab 3 - Paychex or TJH Payroll - Toggle Off Example">
      <Steps />
    </div>
  );
}
...
function VideoFrame() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="VideoFrame">
...
export default function Component3Tab3PaychexAndTjhPayrollWithToggleOff() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="3. Tab 3 (Paychex and TJH Payroll) with toggle OFF">
      <Navigation />
      <Hr />
      <Hero />
      <Tab3PaychexOrTjhPayrollToggleOffExample />
      <Section />
      <Chatbot />
      <Section1 />
