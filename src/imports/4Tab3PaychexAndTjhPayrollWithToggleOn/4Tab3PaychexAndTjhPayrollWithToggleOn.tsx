...
function Steps() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center max-w-[1140px] relative shrink-0 w-full" data-name="Steps">
      <Header />
      <Levelradios />
      <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-[1140px]" data-name="Tab 3 - Paychex or TJH Payroll - Toggle On">
        <Tabs />
        <Body />
      </div>
    </div>
...
function Tab3PaychexOrTjhPayrollToggleOnExample() {
  return (
    <div className="bg-[#f2f0e9] content-stretch flex flex-col items-center justify-center mb-[-1px] overflow-clip py-[80px] relative shrink-0 w-[1440px]" data-name="Tab 3 - Paychex or TJH Payroll - Toggle On Example">
      <Steps />
    </div>
  );
}
...
export default function Component4Tab3PaychexAndTjhPayrollWithToggleOn() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="4. Tab 3 (Paychex and TJH Payroll) with toggle ON">
      <Navigation />
      <Hr />
      <Hero />
      <Tab3PaychexOrTjhPayrollToggleOnExample />
      <Section />
      <Chatbot />
      <Section1 />
