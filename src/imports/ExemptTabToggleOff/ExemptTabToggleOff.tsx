import svgPaths from "./svg-nzhjz7tq1o";
...
export default function ExemptTabToggleOff() {
  return (
    <div className="content-stretch flex flex-col isolate items-start relative size-full" data-name="Exempt Tab Toggle Off">
      <Frame />
    </div>
  );
}