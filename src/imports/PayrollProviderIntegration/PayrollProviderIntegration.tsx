...
function Steps1() {
  return (
    <div
      className="gap-x-[32px] gap-y-[32px] p-[24px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[repeat(1,fit-content(100%))] relative shrink-0 w-full"
      data-name="Steps"
    >
      <Step />
      <div
        className="aspect-[611/679] col-3 justify-self-stretch relative row-1 shrink-0"
        data-name="image 276"
      >
        <img
          alt=""
