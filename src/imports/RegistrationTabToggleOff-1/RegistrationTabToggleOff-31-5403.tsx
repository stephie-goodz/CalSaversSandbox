import svgPaths from "./svg-x7lwfvksf8";
...
export default function RegistrationTabToggleOff() {
  return (
    <div className="content-stretch flex flex-col isolate items-start relative size-full" data-name="Registration Tab Toggle Off">
      <Frame />
    </div>
  );
}