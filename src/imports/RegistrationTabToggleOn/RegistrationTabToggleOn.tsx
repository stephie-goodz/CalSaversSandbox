import svgPaths from "./svg-36zvgg90yr";
...
export default function RegistrationTabToggleOn() {
  return (
    <div className="content-stretch flex flex-col isolate items-start relative size-full" data-name="Registration Tab Toggle On">
      <Frame />
    </div>
  );
}